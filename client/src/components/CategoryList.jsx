...
const CategoryList = () => {
    ...
    return (
        <div className=" flex bg-liber-200  items-center justify-evenly text-blue-300 p-2 lg:px-5 shadow-lg ">
            <h1 className="text-blue-300 hover:text-slate-300 text-xl italic cursor-pointer">Fiction</h1>
            ...
            <h1 className="text-blue-300 hover:text-slate-300 text-xl italic cursor-pointer">Romance</h1>
        </div>
    )
}
